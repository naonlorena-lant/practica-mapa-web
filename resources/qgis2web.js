...
map.getView().fit([-8515875.552378, -5841966.747457, -6634375.779049, -4825537.240278], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">unidades de vegetacion </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (48 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'lorena naon<br />lic. en geografia<br />prof. en geografia';
            }
